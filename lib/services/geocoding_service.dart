  ...
  static Future<Map<String, dynamic>?> getAddressFromCoordinates(
    ...
    try {
      ...
      if (!connectivityService.hasConnection) {
        print('GeocodingService: No internet connection, returning default location');
        return _getDefaultLocation(latitude, longitude);
      }
      ...
      // Return a default location rather than null
      return _getDefaultLocation(latitude, longitude);
    }
  }
